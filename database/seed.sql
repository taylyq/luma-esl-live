...
('admin', 'Admin', 'admin@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', NOW(), NULL, 'active', NOW(), NOW()),
('student', 'Minh Tran', 'student@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', NOW(), NULL, 'active', NOW(), NOW()),
('educator', 'Amelia Carter', 'amelia@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', NOW(), NULL, 'active', NOW(), NOW()),
('educator', 'Linh Nguyen', 'linh@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', NOW(), NULL, 'active', NOW(), NOW()),
('educator', 'Marcus Lee', 'marcus@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', NOW(), NULL, 'active', NOW(), NOW())
ON DUPLICATE KEY UPDATE email = VALUES(email), email_verified_at = VALUES(email_verified_at), age_confirmed_at = VALUES(age_confirmed_at), terms_accepted_at = VALUES(terms_accepted_at);
