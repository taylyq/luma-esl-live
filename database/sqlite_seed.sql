INSERT INTO users (role, name, email, password, email_verified_at, avatar, status, age_confirmed_at, terms_accepted_at) VALUES
('admin', 'Admin', 'admin@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', CURRENT_TIMESTAMP, NULL, 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('student', 'Minh Tran', 'student@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', CURRENT_TIMESTAMP, NULL, 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('educator', 'Amelia Carter', 'amelia@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', CURRENT_TIMESTAMP, NULL, 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('educator', 'Linh Nguyen', 'linh@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', CURRENT_TIMESTAMP, NULL, 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('educator', 'Marcus Lee', 'marcus@luma.test', '$2y$12$6ITd8uWlC9v28xa50NSbweUEM0Dm.L.BozvZ1PJNy8oDibFtKqqVu', CURRENT_TIMESTAMP, NULL, 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
